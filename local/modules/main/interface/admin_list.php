...
<td class="adm-list-table-cell" style="text-align: center;vertical-align: initial;padding: 10px;">
                  ...
                  <a data-id="<?=$this->id?>" class="open_popupOP pp" target="_blank" href="/bitrix/admin/sale_print.php?PROPS_ENABLE=Y&doc=russianpost-cod&ORDER_ID=<?=$this->id?>"  style="cursor: pointer;"><img title="Печать" src="/images/stamp.png"></a>           
