...
class RetailCrmICML
{
                            ...
                            foreach ($product['offers'] as $offer) {
                                ...
                                foreach ($resPropertiesProduct as $key => $propProduct) {
                                    if ($this->propertiesProduct[$id][$key] != "" && !isset($offer[$key])) {
									   ...
									   //@fwrite($this->fp,print_r($offer,true));
    ...
    {
		//@fwrite($this->fp,print_r($arOffer,true));
        $offer = "";
		if(!empty($arOffer['_PROP_article'])){
			//$arOffer["PRODUCT_ID"] = $arOffer['_PROP_article'];
			if(!empty($arOffer['_PROP_size'])){
				$offerid  = $arOffer["ID"];
				$arOffer["ID"] = $arOffer['_PROP_article'] . ';;'.$arOffer['_PROP_size'];
        ...
        $offer .= "<name>" . $this->PrepareValue($arOffer["NAME"]. "(".$arOffer['_PROP_size'].")"). "</name>\n";

		$offer .= "<xmlId>" . $this->PrepareValue($offerid/*$arOffer["EXTERNAL_ID"]*/) . "</xmlId>\n";
