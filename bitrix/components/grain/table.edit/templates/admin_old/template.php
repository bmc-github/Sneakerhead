...
if($arResult["USE_FILEMAN"]) CAdminFileDialog::ShowScript(Array(
	"event" => "_grainTable_OpenFM",
	"arResultDest" => array("FUNCTION_NAME" => "grainTableFilemanReturn"),
...
if($arResult["USE_MEDIALIB"]) CMedialib::ShowDialogScript(Array(
	"event" => "_grainTable_OpenML",
	"arResultDest" => array("FUNCTION_NAME" => "grainTableMedialibReturn"),
	"arPath" => array("SITE" => SITE_ID, "PATH" =>"/upload"),
    "select" => 'F',// F - file only, D - folder only
    "operation" => 'O',
    "showUploadTab" => true,
