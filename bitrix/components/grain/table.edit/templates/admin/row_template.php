...
?>
<input type="text" size="16" id="grain_table_date_field_<?=$id?>" name="<?=$name?>" value="<?=htmlspecialcharsbx($value)?>" size="<?=$arColumn["SIZE"]?>" />
<?
...
?>
<input type="text" name="<?=$name?>" id="grain_table_fp_field_<?=$id?>" value="<?=htmlspecialcharsbx($value)?>" /><?if($arResult["USE_FILEMAN"] && $arColumn["ALLOW_FILEMAN"]=="Y"):?>&nbsp;<a href="#" onclick="window.grain_table_tmp_input_id='grain_table_fp_field_<?=$id?>'; window._grain_Table_OpenFM(); return false;" title="<?=GetMessage("GRAIN_TABLES_TE_TEMPLATE_STRUCTURE")?>"><img class="grain-tables-table-edit-file-icon" src="/bitrix/images/fileman/medialib/tabs/server.gif" width="16" height="16" border="0" alt="<?=GetMessage("GRAIN_TABLES_TE_TEMPLATE_STRUCTURE")?>" /></a><?endif?><?if($arResult["USE_MEDIALIB"] && $arColumn["ALLOW_MEDIALIB"]=="Y"):?>&nbsp;<a href="#" onclick="window.grain_table_tmp_input_id='grain_table_fp_field_<?=$id?>'; window._grain_Table_OpenML(); return false;" title="<?=GetMessage("GRAIN_TABLES_TE_TEMPLATE_MEDIALIB")?>"><img class="grain-tables-table-edit-file-icon" src="/bitrix/images/fileman/medialib/tabs/media.gif" width="16" height="16" border="0" alt="<?=GetMessage("GRAIN_TABLES_TE_TEMPLATE_MEDIALIB")?>" /></a><?endif?>
