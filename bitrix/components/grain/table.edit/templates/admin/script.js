...
window.grain_table_tmp_input_id = "";

window.grain_TableMedialibReturn = function (return_path) {

	if(window.grain_table_tmp_input_id.length>0) {
		
		obField = window.document.getElementById(window.grain_table_tmp_input_id);
...
window.grain_TableFilemanReturn = function (filename,foldername,site_id) {
