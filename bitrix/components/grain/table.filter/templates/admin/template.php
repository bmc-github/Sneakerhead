			...
			switch(cur_type) {
				...
				case 'link':
					...
					if(grain_tables_filter_<?=$arResult["JS_TEMPLATE_ID"]?>[cur_col].INSTANCE_IDENTIFIER) {
						...
						newInputLinkValues.className = grain_tables_filter_<?=$arResult["JS_TEMPLATE_ID"]?>[cur_col].TEMPLATE_IDENTIFIER + "-values " + grain_tables_filter_<?=$arResult["JS_TEMPLATE_ID"]?>[cur_col].TEMPLATE_IDENTIFIER + "-values-admin";
...
<span class="adm-input-wrap"><span style="white-space: nowrap" class="grain-tables-filter">
	...
	switch($cur_type):
		...
		case "link":
			...
			<span class="<?=$arColumn["TEMPLATE_IDENTIFIER"]?>-values <?=$arColumn["TEMPLATE_IDENTIFIER"]?>-values-admin" id="grain_tables_cur_input_link_values_<?=$arResult["JS_TEMPLATE_ID"]?>">
