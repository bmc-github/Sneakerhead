...
if (strlen($request->get('ORDER_ID')) > 0) {
    ...
    <? if (SITE_TEMPLATE_ID == "sd") {
        $APPLICATION->SetPageProperty('class', 'checkout-page');
        $columns = array("NAME","DISCOUNT","PROPS","PRICE","QUANTITY","SUM","DELETE");
    } else {
        $APPLICATION->SetPageProperty('class', 'cart');
        $columns = array("NAME","PROPS","QUANTITY","DISCOUNT","PRICE","DELETE");
    } ?>
    ...
    <form action="<?= $APPLICATION->GetCurPage(); ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
        ...
        <div id="bx-soa-order" class="row bx-custom" style="opacity: 0">
            <!--	MAIN BLOCK	-->
            <!--	SIDEBAR BLOCK	-->
            <div class="col-sm-3 checkout-steps-titles"></div>
 			<?/*<table id="total" style="width:auto;" class="col-sm-9 checkout-steps-contents">
				<tr>
                    <td class="title"><b><?= GetMessage("SALE_TOTAL") ?></b></td>
                    <td class="sum" ><div class="bx-soa-cart-total"></div></td>
                </tr>
            </table>
*/?>
            <div class="col-sm-9 checkout-steps-contents"<?if(SITE_TEMPLATE_ID == "sm") echo ' style="display:none"';?>>
            ...
            <div class="col-sm-12"<?if(SITE_TEMPLATE_ID == "sm") echo ' style="display:none"';?>><hr class="hr-order"/></div>
            <div class="col-sm-3 checkout-steps-titles">
                <div class="bx-soa-steps-titles">
                    <ul>
                        <li class="active" data-title-id="bx-soa-properties"><a href="#" class="checkout-heading">Контактные данные</a></li>
                        <li data-title-id="bx-soa-region"><a href="#" class="checkout-heading">Адрес доставки</a></li>
                        <li data-title-id="bx-soa-delivery"><a href="#" class="checkout-heading">Способ доставки</a></li>
                        <li style="display: none" data-title-id="bx-soa-pickup"><a href="#" class="checkout-heading">Пункты самовывоза</a></li>
                        <li data-title-id="bx-soa-paysystem"><a href="#" class="checkout-heading">Способ оплаты</a></li>
                        <li data-title-id="bx-soa-basket"><a href="#" class="checkout-heading">Подтверждение</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-9 bx-soa checkout-steps-contents">
                <div id="bx-soa-main-notifications">
                    <div class="alert alert-danger" style="display:none"></div>
                    <div data-type="informer" style="display:none"></div>
                </div>
                <!--	AUTH BLOCK	-->
                <div id="bx-soa-auth" class="bx-soa-section bx-soa-auth hidden" style="display:none">
                ...
                <div id="bx-soa-total-mobile" class="hidden" style="margin-bottom: 6px;"></div>

                <!--	BUYER PROPS BLOCK	-->
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container hidden">
                        <h2 class="bx-soa-section-title col-sm-9">
                ...
                <!--	ORDER SAVE BLOCK	-->
                <div id="bx-soa-orderSave" class="bx-soa-section-final">
                    <div class="bx-soa-section-content container-fluid">
                        <div class="checkout-confirm">
                            <div class="checkout-confirm-row">
                                <p class="checkout-confirm-title">Контактные данные</p>
                                <p class="checkout-confirm-content" id="final-contacts-data"></p>
                            </div>
                            <div class="checkout-confirm-row">
                                <p class="checkout-confirm-title">Адрес доставки</p>
                                <p class="checkout-confirm-content" id="final-address-data"></p>
                            </div>
                            <div class="checkout-confirm-rowflat">
                                <p class="checkout-confirm-titleflat">Способ доставки</p>
                                <p class="checkout-confirm-contentflat" id="final-delivery-data"></p>
                            </div>
                            <div class="checkout-confirm-rowflat">
                                <p class="checkout-confirm-titleflat">Способ оплаты</p>
                                <p class="checkout-confirm-contentflat" id="final-paysystem-data"></p>
                            </div>
                            <div class="pseudo-comment"></div>
                            <div class="checkout-cart-total">
                                <span>Итого:</span>
                                <strong id="final-sum-data"></strong>
                            </div>
                        </div>
                        <div class="checkbox">
                            <?
                        ...
                        <div class="row bx-soa-more">
                            <div class="bx-soa-more-btn col-xs-12">
                                <a href="javascript:void(0)" data-prev-button="true" class="pull-left btn btn-prev">Назад</a>
                                <a href="javascript:void(0)" data-save-button="true"
                                   class="pull-right btn btn-next"><?= $arParams['MESS_ORDER'] ?></a>
                            </div>
                        </div>
                    </div>
                </div>
