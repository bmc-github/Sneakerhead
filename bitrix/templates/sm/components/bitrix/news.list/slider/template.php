...
?>
                    <div class="t-carousel__item item t-carousel__animation_fast<?if($i==0) echo ' active';?>" style="height:650px;background-image:url('<?=$arItem[PREVIEW_PICTURE][SRC]?>');" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                      <a href="<?=$arItem["DETAIL_PAGE_URL"]?>">           
                        <div class="t406__table" style="height:650px;">
                          <div class="t406__cell t-align_center t-valign_middle">
                            <div class="t406__bg" data-bgimgfield="img" style="background-image:url('<?=$arItem[PREVIEW_PICTURE][SRC]?>');"></div>
...
<?}?>
                  ...
                  foreach($arResult["ITEMS"] as $i=>$arItem){
                    ...
                    ?>                           
                    <li style="background-color:#fff;" class="t-carousel__indicator <?if ($j==0){echo 'active';}?>" data-target="#t-carousel8511508" data-slide-to="<?=$j;?>"></li>
                    <?
                    $j++;
