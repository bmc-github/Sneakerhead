...
<?if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])){
    ...
    foreach ($arResult['ITEMS'] as $i=>$item){
      ...
      $gtm[] = "{'id': '".$item['ID']."', 'categoryId': '".$arResult['ID']."', 'list': '".$arResult['NAME']."',	'position': '".$i."'}";
    }
...
<script>
  function productClick(category_id, value, id){
    dataLayer.push({
      'event': 'productClick',
      'ecommerce': {
	'click': {
