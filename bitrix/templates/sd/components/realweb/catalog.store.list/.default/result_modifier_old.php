...
$arElement_A = CIBlockElement::GetList(Array(),Array("IBLOCK_ID"=>19,/*"PROPERTY_SIZE"=>$SZ,*/"PROPERTY_ARTICLE"=>$article_p,"PROPERTY_C_CODES"=>$code1c),false,false,Array("PROPERTY_OOO","ID",'NAME','PROPERTY_ORDER','PROPERTY_NAME_T','PROPERTY_SIZE','PROPERTY_SKLAD_O','PROPERTY_C_CODES','PROPERTY_PRICE','PROPERTY_ARTICLE','PROPERTY_ACCOUNT_NUMBER'))->GetNext();
...
$arElement = CIBlockElement::GetList(Array(),Array("IBLOCK_ID"=>19,/*"PROPERTY_SIZE"=>$SZ,*/"PROPERTY_ARTICLE"=>$article_p,"PROPERTY_C_CODES"=>$code1c,"PROPERTY_OOO" => GPropertyTable::GetColumnFilter("out",$ah['ID'])),false,false,Array("ID","NAME",'PROPERTY_OOO',"DATE_CREATE",'PROPERTY_ORDER'))->GetNext();
...
rename('ftp://sneake01_ftp:6BjvOObrXT@ftp.sneake01.nichost.ru/fromHC/bitrix/ReceiveDocs/'.$filename, 'ftp://sneake01_ftp:6BjvOObrXT@ftp.sneake01.nichost.ru/fromHC/bitrix/ReceiveDocs/'.$filename.'_'.date("Y-m-d H:i:s"));
};
//};
};
...
$roM = CSaleOrder::GetList(array($sT[0]=>$sT[1]), array('STATUS_ID'=>'F','DELIVERY_ID'=>3), false, false, array("ID","STATUS_ID","DELIVERY_ID",'ACCOUNT_NUMBER'/*,"DELIVERY_ID","STATUS_ID","PRICE","DISCOUNT_VALUE", "USER_NAME", "DATE_UPDATE"*/));
$orderM = array();
...
if ($productZ["PROPERTY_OOO_VALUE"]["stat"]!="approved=1"){
