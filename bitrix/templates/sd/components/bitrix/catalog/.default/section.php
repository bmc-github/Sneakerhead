...
if($_REQUEST['PAGEN_1'] && $_REQUEST['PAGEN_1']>1){
  ...
  $APPLICATION->SetPageProperty('description', 'Страница №'.$_REQUEST['PAGEN_1'].': '.$meta['ELEMENT_META_DESCRIPTION']);
  $APPLICATION->SetTitle(($meta['ELEMENT_PAGE_TITLE'] ? $meta['ELEMENT_PAGE_TITLE'] : $GLOBALS['meta']['h1']).' — страница №'.$_REQUEST['PAGEN_1']);
