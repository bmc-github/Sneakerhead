...
$APPLICATION->AddHeadString('<meta property="product:original_price:amount" content="'.number_format($arResult[PROPERTIES][PRICE][VALUE], 2, '.', '').'" />');
$APPLICATION->AddHeadString('<meta property="product:original_price:currency" content="RUB" />');
$APPLICATION->AddHeadString('<meta property="product:availability" content="instock" />');
*/
