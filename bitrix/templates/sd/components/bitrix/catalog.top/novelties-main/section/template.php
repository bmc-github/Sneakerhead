...
?>
            ...
            <div class="row featured_block" itemprop="hasOfferCatalog" itemscope itemtype="http://schema.org/OfferCatalog" data-entity="<?=$containerName?>">	   
...
<script>
  ...
  function productClick(category_id, value, id) {
    dataLayer.push({
      'ecommerce': {
	'click': {
	  'actionField': {'list': 'Новые поступления'},
	  'products': [{
		 	 'id':  id.toString() ,
