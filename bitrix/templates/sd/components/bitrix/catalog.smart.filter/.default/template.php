...
?>
<div id="filterpro_box" class="bx-filter <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?> box">
    <div class="bx-filter-section container-fluid box-content filterpro">
        ...
        <form id="filterpro" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
            ...
            <div class="row">
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem)
                {
                    ...
                    if (
                        ...
                        continue;
                    ?>
                    <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?> filterRow">
                        <span class="bx-filter-container-modef"></span>
