...
if (!empty($arResult['NAV_RESULT'])){
	$arResult['NAV_RESULT']->nPageWindow = 11;
	$navParams =  array(
...
?> 
          ...
          <div class="row product-grid" itemscope itemtype="http://schema.org/Service">
...
<?}
  if($_SERVER['REAL_FILE_PATH'] == '/catalog/index.php' || $_SERVER['REAL_FILE_PATH'] == '/catalog/detail.php'){?>
          <div style="background: #fff; margin-bottom: 20px">
            <div data-retailrocket-markup-block="57ea557565bf190134794250" data-algorithm-argument="<?=$arResult['XML_ID']?>"></div>
          </div>
<?  if($arParams['HIDE_SECTION_DESCRIPTION'] !== 'Y'){
      ...
      if($curPage){
        ...
        if($rs->GetNext() && empty($_REQUEST['PAGEN_1']) && ($_SESSION['lang']==NULL || $_SESSION['lang']=='ru')){
?>


<?php if(empty($_REQUEST['PAGEN_1'])) { ?>
...
<?$APPLICATION->IncludeComponent(
	...
	false
           ...
           <!--  <p class="read-more"><a class="button" href="#"><?//=Loc::getMessage('READ_MORE');?></a></p> -->
	  </div>
